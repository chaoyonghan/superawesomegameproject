...
HRESULT CD3DSettingsDlg::OnD3D10ResizedSwapChain( ID3D10Device* pd3dDevice, const DXGI_SURFACE_DESC* pBackBufferSurfaceDesc )
{
    ...
    m_Dialog.SetBackgroundColors( D3DCOLOR_ARGB(255, 152, 179,  92),
                                  D3DCOLOR_ARGB(255, 145, 179,  80),
                                  D3DCOLOR_ARGB(255,  83, 124,  13),
    ...
    m_RevertModeDialog.SetBackgroundColors( D3DCOLOR_ARGB(255, 152, 179,  92),
                                  D3DCOLOR_ARGB(255, 145, 179,  80),
                                  D3DCOLOR_ARGB(255,  83, 124,  13),
                                  D3DCOLOR_ARGB(255,   0,   0,   0) );
